...
import { getCollections, getImageUrl } from '../../../services/api';
...
const ColeccionesIndex = () => {
    ...
    if (loading) {
        return (
            <div className="colecciones-index-view fade-in">
                <PremiumLoader text="Descubriendo nuestras colecciones..." />
            </div>
        );
    }
        ...
        <div className="collections-index-view fade-in">
            ...
            <header className="collections-hero">
                <div className="hero-content">
                    ...
                    <h1 className="hero-title">Nuestras Curadurías</h1>
