...
const Search = () => {
    ...
    const results = useMemo(() => {
        ...
        // Eliminar duplicados (si el producto base y la variante coinciden, preferir variante si es búsqueda específica)
        const unique = [];
        const seen = new Set();
                        ...
                        {results.map(item => (
                            ...
                            >
                                <ElementoColeccion 
                                    ...
                                    precio={item.price ? `$ ${item.price.toLocaleString('es-CL')}` : 'Consultar'}
