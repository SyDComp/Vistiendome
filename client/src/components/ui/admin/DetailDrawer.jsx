...
import { Edit2, Save, Trash2, ArrowLeft, Image as ImageIcon, Sparkles, Folder, Tag, Layers, FileText, Check, LayoutDashboard, Database, ChevronRight, Share2, Upload, AlertCircle, Maximize2, X, Package, FolderOpen, RefreshCw, BarChart2, Info, Lock, ChevronLeft, Plus, Hash, List, Palette, LayoutList } from 'lucide-react';
        ...
        <div className="detail-drawer-overlay" style={{ display: (isOpen || isVisible) ? 'flex' : 'none' }}>
            ...
            <div className="detail-drawer-main-panel" style={{
                                                        ...
                                                        <div className="detail-drawer-reorder-actions">
                                                            {i > 0 && (
                                                                <button 
                                                                    ...
                                                                    className="detail-drawer-reorder-arrow-btn"
                                                                >
                                                                    <ChevronLeft size={16} />
                                                                </button>
                                                            )}
                ...
                <div className="detail-drawer-footer">
                    {['variant', 'color_option', 'homepage_section', 'cms_block', 'category', 'characteristic'].includes(currType) && onDelete && currData && (['category', 'characteristic'].includes(currType) ? !currData.is_system && (currType !== 'category' || editData.is_editing) : true) && (
                        <Button 
                            variant="outline" 
                            type="button"
                            onClick={async () => {
                    ...
                    {['variant', 'color_option', 'homepage_section', 'cms_block', 'category', 'characteristic'].includes(currType) && onUpdate && currData && (['category', 'characteristic'].includes(currType) ? !currData.is_system && (currType !== 'category' || editData.is_editing) : true) && (
                        <Button 
                            onClick={() => {
